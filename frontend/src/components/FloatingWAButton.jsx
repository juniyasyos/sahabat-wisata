...
export default function FloatingWAButton() {
  ...
  const buttonElement = (
    <a
      ...
      className="fixed bottom-6 right-6 z-[9999] w-14 h-14 bg-teal-500 hover:bg-teal-600 rounded-full flex items-center justify-center shadow-lg transition-all duration-200 hover:scale-110 hover:shadow-xl group"
